...
class PushNotificationService {
    ...
    ConnectyCube.pushnotifications.subscriptions
      ...
      .then((result) => {
        ...
        AsyncStorage.setItem(
          PushNotificationService.DEVICE_SUBSCRIPTION_ID,
  ...
  async onNotificationOpened(payload) {
    const dialogId =
      Platform.OS === "ios" ? payload.dialog_id : payload.extra.dialog_id;
    console.log(
      "PushNotificationService - onNotificationOpened - dialogId",
      dialogId,
      payload
    );
